...
public class CommandManagement {
    ...
    public CommandManagement(HashSet<String> superCoreScripts, CollectionManager manager) {
        ...
        addCommandBuilder(new RemoveGreater(manager));
        addCommandBuilder(new MinByName(manager));
        addCommandBuilder(new SumOfManufactureCost(manager));
        addCommandBuilder(new FilterStartsWithPartNumber(manager));
